        ...
        methods: {
            async registro() {
                if(this.input.username != "" && this.input.password != ""){
                    ...
                    if(reb.data == null){
                        console.log('good');
                        axios.post('https://pepunab.herokuapp.com/PepData/post/TextChallenge/'+this.input.username+'/'+this.input.password,{crossdomain: true}); 
            ...
            async verRegistro(){
                return await axios.get('https://pepunab.herokuapp.com/PepData/getUserVerification/TextChallenge/'+this.input.username,{crossdomain: true})
            }
        }
    }
</script>
